# Schmidt et al (under review in GRL)

This repository contains all scripts used to analysis the model output and produce the figures as well as the necessary data which is in the folder data_published/.
